...
from models.transformer.transformer_custom_implementation import PositionalEncoder, Encoder
...
class TransformerPredictor(nn.Module):
  ...
  def setup(self) -> None:
    ...
    self.transformer = Encoder(num_encoder_layers=self.num_encoder_layers,
    ...
    self.output_net = [
        ...
        nn.LayerNorm(name='output_norm'), nn.relu,
